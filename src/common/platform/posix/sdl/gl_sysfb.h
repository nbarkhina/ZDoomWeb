...
// Use the explicit SDL2/ path so the include bypasses emscripten's "fakesdl"
// stub <SDL.h> (force-included via -iwithsysroot/include/fakesdl) and reaches
// the real SDL2 port headers — needed for SDL_GLContext in TUs that don't
// carry -sUSE_SDL=2 (the GL/GLES framebuffer sources).
#include <SDL2/SDL.h>
#else
#include <SDL.h>
#endif
